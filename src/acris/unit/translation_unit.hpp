#ifndef ACRIS_ACRIS_UNIT_TRANSLATION_UNIT_HPP
#define ACRIS_ACRIS_UNIT_TRANSLATION_UNIT_HPP
...
class TranslationUnit {
  ...
  //! Acris compiler regular compilation flow.
...
#endif // ACRIS_ACRIS_UNIT_TRANSLATION_UNIT_HPP
