#ifndef ACRIS_ACRIS_SYMBOL_TABLE_SYMBOL_TABLE_FACTORY_HPP
#define ACRIS_ACRIS_SYMBOL_TABLE_SYMBOL_TABLE_FACTORY_HPP
...
#endif // ACRIS_ACRIS_SYMBOL_TABLE_SYMBOL_TABLE_FACTORY_HPP
