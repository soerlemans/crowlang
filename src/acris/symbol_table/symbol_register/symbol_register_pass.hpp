#ifndef ACRIS_ACRIS_SYMBOL_TABLE_SYMBOL_REGISTER_SYMBOL_REGISTER_PASS_HPP
#define ACRIS_ACRIS_SYMBOL_TABLE_SYMBOL_REGISTER_SYMBOL_REGISTER_PASS_HPP
...
#endif // ACRIS_ACRIS_SYMBOL_TABLE_SYMBOL_REGISTER_SYMBOL_REGISTER_PASS_HPP
