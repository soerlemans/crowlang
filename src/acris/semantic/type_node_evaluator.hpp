#ifndef ACRIS_ACRIS_SEMANTIC_TYPE_NODE_EVALUATOR_HPP
#define ACRIS_ACRIS_SEMANTIC_TYPE_NODE_EVALUATOR_HPP
...
#endif // ACRIS_ACRIS_SEMANTIC_TYPE_NODE_EVALUATOR_HPP
