#ifndef ACRIS_ACRIS_AST_NODE_OPERATORS_ASSIGNMENT_HPP
#define ACRIS_ACRIS_AST_NODE_OPERATORS_ASSIGNMENT_HPP
...
#endif // ACRIS_ACRIS_AST_NODE_OPERATORS_ASSIGNMENT_HPP
