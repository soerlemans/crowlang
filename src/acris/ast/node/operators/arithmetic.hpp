#ifndef ACRIS_ACRIS_AST_NODE_OPERATORS_ARITHMETIC_HPP
#define ACRIS_ACRIS_AST_NODE_OPERATORS_ARITHMETIC_HPP
...
#endif // ACRIS_ACRIS_AST_NODE_OPERATORS_ARITHMETIC_HPP
