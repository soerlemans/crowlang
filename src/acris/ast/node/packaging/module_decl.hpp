#ifndef ACRIS_ACRIS_AST_NODE_PACKAGING_MODULE_DECL_HPP
#define ACRIS_ACRIS_AST_NODE_PACKAGING_MODULE_DECL_HPP
...
#endif // ACRIS_ACRIS_AST_NODE_PACKAGING_MODULE_DECL_HPP
