#ifndef ACRIS_ACRIS_AST_NODE_FUNCTION_RETURN_TYPE_HPP
#define ACRIS_ACRIS_AST_NODE_FUNCTION_RETURN_TYPE_HPP
...
#endif // ACRIS_ACRIS_AST_NODE_FUNCTION_RETURN_TYPE_HPP
