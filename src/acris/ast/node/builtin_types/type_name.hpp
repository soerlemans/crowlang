#ifndef ACRIS_ACRIS_AST_NODE_BUILTIN_TYPES_TYPE_NAME_HPP
#define ACRIS_ACRIS_AST_NODE_BUILTIN_TYPES_TYPE_NAME_HPP
...
#endif // ACRIS_ACRIS_AST_NODE_BUILTIN_TYPES_TYPE_NAME_HPP
