#ifndef ACRIS_ACRIS_AST_NODE_USER_TYPES_MEMBER_DECL_HPP
#define ACRIS_ACRIS_AST_NODE_USER_TYPES_MEMBER_DECL_HPP
...
#endif // ACRIS_ACRIS_AST_NODE_USER_TYPES_MEMBER_DECL_HPP
