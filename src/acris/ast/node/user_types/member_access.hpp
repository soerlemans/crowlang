#ifndef ACRIS_ACRIS_AST_NODE_USER_TYPES_MEMBER_ACCESS_HPP
#define ACRIS_ACRIS_AST_NODE_USER_TYPES_MEMBER_ACCESS_HPP
...
#endif // ACRIS_ACRIS_AST_NODE_USER_TYPES_MEMBER_ACCESS_HPP
