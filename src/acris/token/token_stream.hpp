#ifndef ACRIS_ACRIS_TOKEN_TOKEN_STREAM_HPP
#define ACRIS_ACRIS_TOKEN_TOKEN_STREAM_HPP
...
// Absolute Includes:
#include "acris/container/stream.hpp"
#include "acris/token/token.hpp"
...
#endif // ACRIS_ACRIS_TOKEN_TOKEN_STREAM_HPP
